function [Phi_xy,Psi_xy,Grad_Psi_x,Grad_Psi_y,grad2x,grad2y] = tie(I1,I0,I2,ps,lambda,dz,epsilon1,epsilonI)
% function [Phi_xy,Psi_xy,Grad_Psi_x,Grad_Psi_y,grad2x,grad2y] = tie(I1,I0,I2,ps,lambda,dz,epsilon1,epsilonI)
...
%epsilon1   :                                       Normalize for zero frequency
%epsilonI   :                                       Normalize for zero intensity
...
epsilon2 = epsilon1;
Del2_Psi_xy = (1*k*(I2-I1)/dz);
Psi_xy = poisson_solve_symm(Del2_Psi_xy,ps,N,epsilon1);
...
Phi_xy = poisson_solve_symm(Del2_Phi_xy,ps,N,epsilon2);
